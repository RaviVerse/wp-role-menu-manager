...
require_once WRMM_DIR . 'includes/class-wrmm-users.php'; // NEW FILE
...
function wrmm_init() {
    ...
    if ( is_admin() ) {
        ...
        new WRMM_Users(); // Initialize User Exceptions UI
    }
}
...
function wrmm_activate() {
    ...
    if ( ! get_option( 'wrmm_user_exceptions' ) ) add_option( 'wrmm_user_exceptions', array() ); // New Option
}